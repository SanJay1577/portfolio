  ...
  return (
    <div className="about-page">
      <div className="left-side">
        ...
        <h2>
          Hi, I'm an Well-qualified Full Stack Developer familiar with wide
          range of programming utilities and languages. Knowledgeable of backend
          and frontend development requirements with database mangement. Handles
          any part of process with ease. Collaborative team player with
